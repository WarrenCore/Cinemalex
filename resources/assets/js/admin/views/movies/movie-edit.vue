            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-10">
                            <input v-validate="'required|max:30'" name="name" class="form-control" v-model="data.movie.name" type="text" placeholder="Name"
                            />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-10">
                            <input v-validate="'required|numeric|max:4'" name="year" class="form-control" v-model="data.movie.year" type="text" placeholder="Years"
                            />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-10">
                            <textarea v-validate="'required'" name="overview" class="form-control" v-model="data.movie.overview" type="text" placeholder="Overview"
                            />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-10">
                            <input v-validate="'required|decimal|max:10'" name="runtime" class="form-control" v-model="data.movie.runtime" type="text"
                                placeholder="Runtime" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-10">
                            <input v-validate="'required|decimal|max:5'" name="rate" class="form-control" v-model="data.movie.rate" type="text" placeholder="Rate"
                            />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-10">
                            <input v-validate="'required|url|max:300'" name="youtube" class="form-control" v-model="data.movie.youtube" type="text" placeholder="Trailer"
                            />
                    ...
                    <div class="form-group">
                        <div class="col-12 col-md-6">
                            <button class="btn btn-sm btn-outline-primary" @click="update(data.movie.id)">Update</button>
                        </div>
                    </div>
                </div>

                <div class="col-12 col-md-6" id="cast">
                    <h4>Cast</h4>
                    <div class="row">
                        <div class="col-lg-3 col-sm-4 col-12 text-center" v-for="(item, key) in data.cast" :key="key">
                            <div id="img-cast">
                                <img :src="data.cdn.cdn_cast + item.image" :alt="item.image" width="80">
                            </div>
                            <p>{{item.name}}</p>
                            <div class="col-lg-12 col-sm-12 col-12 text-center">
                                <div class="form-group">
                                    <select class="form-control" v-model="item.credit_id" @change="castChange(item.credit_id,key)">
                                        <option value="" selected disabled hidden>Choose</option>
                                        <option v-for="(item,key) in data.all_cast" :value="item.new_credit_id" :key="key">{{item.name}}
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="modal-body p-4">
                                ...
                                <div class="movieapi" v-if="movieedit">
                                    ...
                                    <div class="progress mt-2">
                                        <div class="progress-bar" role="progressbar" :style="{width: percentCompleted + '%', height:'6px' }" :aria-valuenow="percentCompleted"
...
export default {
  ...
  methods: {
    ...
    castChange(selectedCast, key) {
      for (var i = 0; i < this.data.all_cast.length; i++) {
        if (this.data.all_cast[i].new_credit_id === selectedCast) {
          if (this.data.cast[key] === undefined) {
            this.data.cast.push(this.data.all_cast[i]);
          } else {
            this.$set(
              this.data.cast[key],
              "image",
              this.data.all_cast[i].image
            );
            this.$set(this.data.cast[key], "name", this.data.all_cast[i].name);
            this.$set(
              this.data.cast[key],
              "new_credit_id",
              this.data.all_cast[i].new_credit_id
            );
          }
        }
      }
