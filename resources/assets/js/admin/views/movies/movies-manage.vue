<template>
    <div>
        ...
        <div v-else>
            <div class="m-2" v-if="Object.keys(data_search).length  > 0  && data_search.movies !== null ">
                <div class="table table-responsive-sm table-hover">
                    ...
                    <tbody>
                        <tr v-for="(item, index) in data_search.movies" :key="index">
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    <button class="btn btn-sm btn-secondary btn-sm mr-2" @click="ADD_TO_TOP(item.id,index)" v-if="item.movie_id !== item.id"
                                        :id="item.id">
                                        Top
                                    </button>
                                    ...
                                    <router-link class="btn btn-sm btn-outline-primary btn-sm mr-2" :to="{name:'movie_edit', params: {id:item.id}}" role="button">Edit
                                    </router-link>
            ...
            <div class="m-2" v-if="data_search.movies === null || Object.keys(data_search).length === 0">
            ...
            <nav aria-label="pagination" v-if="data_search.movies === null || Object.keys(data_search).length === 0">
  ...
  methods: {
    DELETE(id, key) {
      swal({
        ...
        if (willDelete) {
          this.$store.dispatch("DELETE_MOVIE", {
            id,
            key
          });
        }
        ...
        response => {
          if (response.status === 200) {
            ...
            if (this.subtitles.subtitles !== null) {
              ...
              this.subtitles.subtitles[0] = esponse.data.data;
            }
            setTimeout(() => {
