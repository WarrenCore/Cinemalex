    ...
    <div>
        <div class="m-2" id="mangae-panel">
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <router-link class="nav-link" :to="{name: 'movie-manage'}">Manage</router-link>
                </li>
                <li class="nav-item">
                    <router-link class="nav-link" :to="{name: 'movie-api'}">Api</router-link>
                </li>
                <li class="nav-item">
                    <router-link class="nav-link" :to="{name: 'movie-custom'}">Custom</router-link>
                </li>
            </ul>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6">
                    ...
                    <div class="form-group">
                        <div class="col-12 col-sm-12">
                            ...
                            <select multiple class="form-control" v-validate="'required'" name="genres" v-model="genres" id="genres">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-12 col-sm-12">
                            <input v-validate="'required|decimal|max:3'" name="runtime" class="form-control" v-model="runtime" type="text" placeholder="Runtime"
                            />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-12 col-sm-12">
                            <label class="form-check-label">
                                <input class="form-check-input" v-model="resolution_360" type="checkbox" value="true">
                            </label>
                            360
                            <label class="form-check-label">
                                <input class="form-check-input" v-model="resolution_480" type="checkbox" value="true">
                            </label>
                            480
                            <label class="form-check-label">
                                <input class="form-check-input" v-model="resolution_720" type="checkbox" value="true">
                            </label>
                            720
                            <label class="form-check-label">
                                <input class="form-check-input" v-model="resolution_1080" type="checkbox" value="true"> 1080
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-12 col-sm-12">
                            <input class="form-control" v-model="video_link" type="text" placeholder="Movie link" />
                        </div>
                    </div>

                    <div class="form-group">
                        <div class="col-6">
                            <button class="btn btn-sm btn-outline-primary" @click="MOVIE_UPLOAD(name)">Upload</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6">
                    ...
                    <div class="col-12 col-sm-12">
                        ...
                        <input type="file" id="subtitle" name="subtitle" multiple size="10" @change="infoShow('subtitle','subtitleFileDetails')"
                            class="inputfile">
                ...
                <div class="modal-dialog upload-modal" role="document" v-if="showProgress">
                    <div class="modal-content">
                        <div class="modal-body p-4">

                            <div class="moviedetails" v-if="movieapi">
                                <div class="row">
                                    <div class="svg ml-3">
                                ...
                                <div class="progress mt-2">
                                    <div v-if="percentMovieApi !== 100" class="progress-bar" role="progressbar" :style="{width: percentMovieApi + '%', height:'6px' }"
                                        :aria-valuenow="percentMovieApi" aria-valuemin="0" aria-valuemax="100"></div>
                                    <div v-else>
                            ...
                            <div class="movievideos3 mt-1" v-if="movie_video_s3">
                                <div class="row">
                                    <div class="svg ml-3">
                                ...
                                <div class="progress">
                                    <div v-if="percentMovieUpload !== 100" class="progress-bar" role="progressbar" :style="{width: percentMovieUpload + '%', height:'6px' }"
                                        :aria-valuenow="percentMovieUpload" aria-valuemin="0" aria-valuemax="100"></div>
                                    <div v-else>
                                        <i class="fa fa-circle-o-notch fa-spin"></i> Prepare</div>
                                </div>
...
export default {
  data() {
    return {
      ...
      showProgress: false,
      percentMovieApi: 0,
      percentMovieUpload: 0,
      percentSubtitleUpload: 0,
      movieapi: false,
      movie_video_s3: false,
  ...
  methods: {
    MOVIE_UPLOAD(name) {
      ...
      // Cast
      formData.append("image1", cast1.files[0]);
      formData.append("image2", cast2.files[0]);
      formData.append("image3", cast3.files[0]);
      formData.append("image4", cast4.files[0]);
      ...
      this.$validator.validateAll().then(result => {
        if (result) {
          ...
          this.movieapi = true;
          axios
            .post("/api/admin/new/movie/customupload", formData, progress)
            .then(
              response => {
    ...
    MOVIEVIDEO_S3(id) {
      ...
      // Progress
      this.movie_video_s3 = true;
      const progress = {
        headers: {
          "content-type": "multipart/form-data"
        },
        onUploadProgress: progressEvent => {
          this.percentMovieUpload = Math.round(
            progressEvent.loaded * 100.0 / progressEvent.total
          );
        }
      };
      // Store data
      axios.post("/api/admin/new/movie/movievideo", formData, progress).then(
        response => {
          if (response.status === 200) {
