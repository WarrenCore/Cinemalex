<template>
    <div>
        ...
        <div class="col-12">
                ...
                <div class="col-12 col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="col-12 col-sm-10">
                            <input class="form-control" name="id" v-model="id" v-validate="'required|numeric'" type="text" placeholder="Movie id" />
                    ...
                    <div class="form-group">
                        <div class="col-12 col-sm-12">
                            <label>Resolution
                                <small class="form-text text-muted">Choose under the resolution of video</small>
                            </label>
                        </div>
            ...
            <div class="form-group">
                <div class="col-12 col-sm-10">
                    <button class="btn btn-sm btn-outline-primary" @click="MOVIEDB_API(id)">Upload</button>
                </div>
            </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-body p-4">
                            ...
                            <div class="movieapi" v-if="movieapi">
                                <div class="row">
                                    <div class="svg ml-3">
                            ...
                            <div class="subtitlemovie mt-1" v-if="subtitle_video">
                                ...
                                <div class="progress">
                                    ...
                                    <div v-else> <i class="fa fa-circle-o-notch fa-spin"></i> Prepare</div>
                                </div>
    ...
    MOVIEDB_API(id) {
      ...
      this.$validator.validateAll().then(result => {
        if (result) {
          ...
          this.movieapi = true;
          axios.post("/api/admin/new/movie/movieapi", formData, progress).then(
            response => {
