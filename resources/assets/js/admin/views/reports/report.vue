<template>
  <div>
    ...
    <div v-if="data.reports !== null">
      ...
      <h3>
        <strong>{{data.reports.data[0].name}}</strong>
      </h3>
      <div class="report-modal" v-if="show_report_modal">
        <div class="col-12 col-sm-8 col-lg-8 offset-sm-2 offset-lg-1" id="modal">
          <div class="header">
      ...
      <div class="table-responisve m-2">
        <div class="table table-hover">
          ...
          <tbody>
            <tr v-for="(item, index) in data.reports.data">
              <td>{{item.id}}</td>
              ...
              <td v-if="item.report_readit === 1">
                <span class="badge badge-success">Read it</span>
              </td>
              <td>{{item.created_at}}</td>
              <td>
                <div class="btn-group" role="group">
                  <button class="btn btn-sm btn-secondary btn-sm mr-2" @click="SHOW_REPORT(index)">Show</button>
