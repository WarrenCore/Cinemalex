                    ...
                    <div class="col-12 my-2" v-if="item.m_name  !== null" id="report-box">
                        <div class="row">
                            <div class="col-12 col-sm-2 col-lg-1">
                                <img :src="data.cdn.cdn_poster+item.m_poster" :alt="item.m_poster" width="100%">
                            </div>
                            ...
                            <div class="col-sm-3 col-lg-4">
                                <div class="btn-group float-right" role="group">
                                    <router-link role="button" class="btn btn-sm btn-outline-primary btn-sm mr-2" :to="{name: 'report-show',params: {id:item.id}}">Show</router-link>
                                    <button class="btn btn-sm btn-outline-danger btn-sm mr-2" @click="DELETE(item.m_id,index)" :id="item.id">Delete</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12" v-if="item.t_name !== null" id="report-box">
                        <div class="row">
                            <div class="col-12 col-sm-3 col-md-1">
                                <img :src="data.cdn.cdn_poster+item.t_poster" :alt="item.m_poster" width="100%">
                            </div>
                            <div class="col-12 col-sm-7 col-md-7 text-left">
                                <ul>
                                    <li>
                                        <b>ID:</b> {{item.id}}</li>
                                    <li>
                                        <b>Name:</b> {{item.t_name}}</li>
                                    <li>
                                        <b>Report type:</b>
                                        <span class="badge badge-primary">
                            ...
                            <div class="col-12 col-sm-2 col-md-4 ">
                                <div class="btn-group float-sm-right" role="group">
                                    <router-link role="button" class="btn btn-sm btn-outline-primary btn-sm mr-2" :to="{name: 'report-show',params: {id:item.id}}">Show</router-link>
                                    <button class="btn btn-sm btn-outline-danger btn-sm mr-2" @click="DELETE(item.t_id,index)" :id="item.id">Delete</button>
                                </div>
                            </div>
                        </div>
                    </div>
