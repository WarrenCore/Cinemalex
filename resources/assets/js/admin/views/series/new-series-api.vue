        ...
        <div class="col-12">
            ...
            <div class="form-group">
                <div class="col-12 col-lg-12">
                    <label for="movie-name">ID</label>
                </div>
                <div class="col-12 col-sm-8 col-lg-4">
                    <input class="form-control" name="id" v-model="id" v-validate="'required|numeric'" type="text" placeholder="Moviedb id" />
            ...
            <div class="form-group">
                <div class="col-6">
                    <button class="btn btn-sm btn-outline-primary" @click="SERIES_API()">Upload</button>
                </div>
            </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-body p-4">
                            ...
                            <div class="movieapi" v-if="series_api">
                                <div class="row">
                                    <div class="svg ml-3">
                                ...
                                <div class="progress mt-2">
                                    <div v-if="percentSeriesApi !== 100" class="progress-bar" role="progressbar" :style="{width: percentSeriesApi + '%', height:'6px' }"
    ...
    SERIES_API(id) {
      ...
      const progress = {
        ...
        onUploadProgress: progressEvent => {
          this.percentSeriesApi = Math.round(
      ...
      this.$validator.validateAll().then(result => {
        if (result) {
          ...
          this.series_api = true;
          axios
            .post("/api/admin/new/series/moviedbapi", formData, progress)
            .then(
              response => {
