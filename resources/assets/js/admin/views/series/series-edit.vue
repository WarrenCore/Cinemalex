            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-12">
                            <input v-validate="'required|max:60'" name="name" class="form-control" v-model="data.series.name" type="text" placeholder="Name"
                            />
                    ...
                    <div class="form-group">
                        <div class="col-2">
                            <label for="series-name">Years</label>
                        </div>
                        <div class="col-12">
                            <input v-validate="'required|numeric|max:4'" name="year" class="form-control" v-model="data.series.year" type="text" placeholder="Years"
                            />
                    ...
                    <div class="form-group">
                        <div class="col-2">
                            <label for="series-name">Genres</label>
                        </div>
                        <div class="col-12">
                    ...
                    <div class="form-group">
                        <div class="col-2">
                            <label for="series-name">Overview</label>
                        </div>
                        <div class="col-12">
                            <textarea v-validate="'required'" name="overview" class="form-control" v-model="data.series.overview" type="text" placeholder="Overview"
                            />
                    ...
                    <div class="form-group">
                        <div class="col-2">
                            <label for="series-name">Rate</label>
                        </div>
                        <div class="col-12">
                            <input v-validate="'required|decimal|max:5'" name="rate" class="form-control" v-model="data.series.rate" type="text" placeholder="Rate"
                            />
