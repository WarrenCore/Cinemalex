            ...
            <div class="row">
                <div class="col-12 col-sm-3 col-lg-3">
                    <div class="list-group">
                        <router-link class="list-group-item list-group-item-action" :to="{name: 'profile'}">Profile</router-link>
                        <router-link class="list-group-item list-group-item-action" :to="{name: 'security'}" exact>Security</router-link>
                    </div>
                    <hr>
                ...
                <div class="col-12 col-sm-6 col-lg-4  mt-5" id="profile-setting">
                    ...
                    <div id="avatar-img">
                        <img :src="avatar_image" alt="numberone" id="avatar" width="100">
                    ...
                    <div id="profile-details">
                        ...
                        <div class="form-group">
                            <div class="col-12">
                                <button class="btn btn-sm btn-outline-primary" @click="changeDetails">Update
                                </button>
                            </div>
                        </div>
                    </div>
...
export default {
  ...
  created() {
    ...
    axios.get("api/admin/profile").then(res => {
      this.avatar_image = res.data.url_image + res.data[0].image;
