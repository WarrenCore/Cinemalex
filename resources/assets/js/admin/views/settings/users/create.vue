  ...
  <div>
    <div class="container">
      <div class="col-12 my-3 p-2">
        <div class="group-btn">
          <router-link class="btn btn-sm btn-outline-primary" role="button" :to="{name: 'admins-users-manage'}">Manage</router-link>
        </div>
        <hr>
      </div>
      <!-- END LIST -->
      <div class="col-12 col-sm-8 col-lg-4 offset-sm-2 offset-lg-3" id="profile-setting">
        ...
        <div id="profile-details">
          ...
          <div class="form-group">
            <div class="col-12">
              <button class="btn btn-sm btn-outline-primary" @click="CREATE">Create
              </button>
            </div>
          </div>
        </div>
...
export default {
  ...
  mounted() {
    axios.get("api/admin/settings/backup").then(
      res => {},
      error => {
