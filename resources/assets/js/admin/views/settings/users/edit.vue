    ...
    <div>
        ...
        <div class="container my-5">
            <div class="col-12 col-sm-6 col-lg-4 offset-sm-3 offset-lg-3" id="profile-setting">
                ...
                <div id="avatar-img">
                    <img :src="data.cdn.cdn_user+data.details.image" alt="numberone" id="avatar" width="100" onError="this.onerror=null;this.src='/img/avatar.png';">
                ...
                <div id="profile-details">
                    ...
                    <div class="form-group">
                        <div class="col-12">
                            <button class="btn btn-sm btn-outline-primary" @click="UPDATE_DETAILS">Update
                            </button>
                        </div>
                    </div>
                </div>
