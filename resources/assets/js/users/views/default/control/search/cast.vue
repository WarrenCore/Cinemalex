<template>
    <div>
        ...
        <div class="col-12 cast-content p-2 p-sm-2 p-lg-2">
            ...
            <div class="cast">
                <div class="col-8 col-sm-12 hidden-xs-down ipad-up text-center">
                    <div class="image">
                        <img :src="data.cdn.cdn_cast + data.cast.image" :alt="data.cast.name" width="100%" onError="this.onerror=null;this.src='/themes/default/img/no-image.gif';">
                    </div>
                    <h4>
            ...
            <div class="col-12 mt-5 film-list" v-if="data.filmography !== null">
                ...
                <div class="row">
                    ...
                    <div class="col-6 col-sm-4 col-md-4 col-lg-3 col-xl-3 mb-3 poster" v-for="(item, index) in data.filmography" :key="index"
