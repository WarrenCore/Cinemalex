        ...
        <div class="col-12 collection-content p-2 p-sm-2 p-lg-2">
            ...
            <div class="col-12 mt-5 film-list" v-if="data.data !== null">
                ...
                <div class="row">
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-3 col-xl-2 p-2 mb-3 poster" v-for="(item, index) in data.data" :key="index" @mouseover="active = item.id">
                                ...
                                <div class="poster_img">
                                    ...
                                    <div class="poster_overlay_info" v-if="active === item.id">
                                        ...
                                        <div class="header">
                                            ...
                                            <div class="col-5 col-sm-4  pull-left my-list p-1 p-md-2 p-lg-2 p-xl-2">
