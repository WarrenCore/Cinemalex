    ...
    <div class="row">
      ...
      <div class="col-12 col-sm-9 col-lg-9 offset-sm-3 offset-lg-3 p-sm-3 mt-5 profile-edit h-100">
        <div class="col-12 col-lg-12 plan-form">
          ...
          <hr>
            <div class="row">
              <div class="col-12 col-sm-6 col-md-4 mt-4 offset-md-2 text-center plan-content" @click="plan_id = 1" :class="{active: plan.subscription_plan === 'monthly' && !plan_id, active_choise:plan_id === 1}">
                <h3>{{$t('setting.monthly')}}</h3>
                <h1>{{$t('setting.m_price')}}
                  <small>/{{$t('setting.mo')}}</small>
                </h1>
              </div>
              <div class="col-12 col-sm-6 col-md-4 mt-4 text-center plan-content" @click="plan_id = 2" :class="{active: plan.subscription_plan === 'yearly' && !plan_id,active_choise:plan_id === 2}">
