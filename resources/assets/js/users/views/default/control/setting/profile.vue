...
<!-- Modal -->
<div class="modal fade" id="checkModal" tabindex="-1" role="dialog" aria-labelledby="checkModalLabel" aria-hidden="true" style="z-index:100000000;">
    ...
    export default {
        ...
        methods: {
            UPDATE_IMAGE() {
                ...
                axios.post("/api/v1/update/profile/image", formData).then(response => {
                    if (response.data.status === "success") {
                        this.avatar_image = response.data.cdn_user + response.data.image;
                        this.$auth.setUpdate(null,response.data.cdn_user+response.data.image, null);
                    }
                });
            },
            UPDATE_DETAILS() {
