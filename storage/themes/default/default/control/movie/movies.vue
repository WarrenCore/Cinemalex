                            ...
                            <div class="poster_img">
                                ...
                                <div class="poster_overlay_info" v-if="active === item.id">
                                    ...
                                    <div class="header">
                                        ...
                                        <div class="col-5 col-sm-4  col-md-4 col-lg-4 col-xl-4 pull-left my-list p-1 p-md-2 p-lg-2 p-xl-2">
                                        ...
                                        <div class="col-5 col-sm-4  col-md-4 col-lg-4 col-xl-4 pull-right likes p-1 p-md-2 p-lg-2 p-xl-2">
