<template>
    <div>
        <div class="col-12">
            ...
            <div class="col-12 film-list" v-if="data.series !== null">

                <div class="row">
                    <div class="col-6 col-sm-4 col-md-3 col-lg-3 col-xl-2 p-2 mb-3 poster" v-for="(item, index) in data.series" :key="index"
