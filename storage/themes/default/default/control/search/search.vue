    ...
    <div>
        ...
        <div class="col-12 search-content">
            ...
            <div class="row">
                ...
                <div class="col-2 col-sm-1 col-md-1 col-lg-1 col-xl-1 back" @click="$router.go(-1)">
                ...
                <div class="col-10 col-sm-7 col-lg-4 col-md-4 col-xl-4 search-input">
            ...
            <div class="p-sm-5 p-lg-5" v-if="data.data !== null || data.cast !== null">
                ...
                <div class="row cast ml-md-5 ml-lg-5 ml-md-5" v-if="data.cast !== null">
                    <div class="col-6 col-sm-4 col-md-3 col-lg-3 col-xl-2 mt-2" v-for="(item,index) in data.cast" :key="index" v-if="item.type === 'casts'">
                        <div class="text-center">
                            <router-link :to="{name: 'cast', params: {id: item.id}}">
                                <div class="image" @mouseover="showCast = index">
                                    ...
                                    <div class="ovarlay" v-if="showCast === index">
                                        <p>{{item.name}}</p>
                                    </div>
                ...
                <div class="col-12 mt-5 film-list" v-if="data.data !== null">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 col-sm-4 col-md-4 col-lg-3 col-xl-3 mb-3 poster" v-for="(item, index) in data.data" :key="index" @mouseover="active = item.id">
...
<script>
    ...
    export default {
        ...
        mounted() {
            this.$store.dispatch("GET_SEARCH_LIST", this.$route.params.search);
        },
        methods: {
